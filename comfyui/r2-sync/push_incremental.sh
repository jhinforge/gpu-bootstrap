...
#       example-r2:comfyui-assets/ComfyUI
#   - Cold models live outside the default restore layer:
#       example-r2:comfyui-assets/models_cold
...
R2_REMOTE="${R2_REMOTE:-example-r2:comfyui-assets/ComfyUI}"
R2_ROOT_REMOTE="${R2_ROOT_REMOTE:-example-r2:comfyui-assets}"
